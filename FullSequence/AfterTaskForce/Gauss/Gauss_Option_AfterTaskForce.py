...
def execute(eventType=13104011):
    ...
    # Used in older version of Gauss
...
# For magnet polarity 'down'
    ...
    #After TaskForce tags are the same as the Tdr
    OutName = Decay+"_"+ str(eventType) +"_Upgrade_AfterTaskForceTags_Spillover25_Py8_Upgrade_HorExtAngle_7000GeV_nu7.6_MagDown"
